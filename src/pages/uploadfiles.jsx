...
const UploadFiles = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const uploadRes = await fetch('/uploadfiles', {
        method: 'POST',
        body: formData,
      });
  ...
  return (
    <div className="upload-page">
      ...
      <p className="upload-subtext">Upload and validate your data files with our advanced comparison system.</p>
          ...
          <div className="file-pair">
            <div className="file-box">
              ...
              <div className="file-drop">
                ...
                <label className="file-button">
                  Choose Source File
                  <input type="file" name="sourceFile" hidden onChange={(e) => handleFileChange(e, setSourceFileName)} />
                </label>
            ...
            <div className="file-box">
              ...
              <div className="file-drop">
                ...
                <label className="file-button">
                  Choose Target File
                  <input type="file" name="targetFile" hidden onChange={(e) => handleFileChange(e, setTargetFileName)} />
                </label>
                <p className="file-meta">Accepted: .csv, .xlsx, .txt | Max: 50MB</p>
      ...
      <div className="user-tag">
        <i className="bi bi-person-circle"></i> User ID: 04548776890435805433
      </div>
    </div>
  );
};
