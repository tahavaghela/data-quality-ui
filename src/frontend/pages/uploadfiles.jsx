...
    // Correcting the endpoint from '/api/me' to '/api/session'
    // The original '/api/me' route in main.py returns an object with a 'user' key
    // The original frontend expected a 'user' key, but let's check your other files for context
    axios.get(`${import.meta.env.VITE_API_BASE_URL}/api/session`, { withCredentials: true })
      .then(res => {
        // Assuming your /api/session endpoint returns a user object
        setUser(res.data);
      })
      .catch(err => {
